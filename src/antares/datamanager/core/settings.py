...
class Settings:
    ...
    @property
    def dsr_modulation_directory(self) -> Path:
        return self._resolve_env_path("PEGASE_DSR_TS_OUTPUT_DIRECTORY")

    @property
    def misc_ts_directory(self) -> Path:
    ...
    @property
    def nuclear_talon_ts_directory(self) -> Path:
        return self._resolve_env_path("PEGASE_NUCLEAR_TALON_TS_OUTPUT_DIRECTORY")

    @property
    def nuclear_availability_ts_directory(self) -> Path:
